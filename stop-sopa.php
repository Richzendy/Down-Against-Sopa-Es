...
if ( empty( $sopa_opts['site_link'] ) ) { 
	...
	$continue_link .= wp_get_referer();
}
$continue_link .= '">' . __( 'Quitar este mensaje e ir al sitio.' ) . '</a>';
?>
...
<div id="text-shadow-box">
    ...
    <div id="tsb-wall">
        <div id="tsb-ie"></div>
       <p>Este sitio está 'apagado' hoy, desde las 8.00 a las 20.00 horas, en protesta por las leyes que atentan contra los derechos y libertades en Internet y, concretamente, en apoyo de la movilización que para este día han convocado los internautas estadounidenses contra <a href="http://www.abc.es/20120117/cultura/abci-cierre-horas-wikipedia-sopa-201201171931.html">SOPA y PIPA</a>. Pero igualmente es una protesta contra la aprobada <a href="http://www.elmundo.es/blogs/elmundo/jaqueperpetuo/2012/01/04/ley-sinde-wert-no-nos-rendiremos-jamas.html">Ley Sinde-Wert</a> en España, ya que sus orígenes y sus objetivos son exactamente los mismos. Únete a esta movilización mostrando en tu web <a href="https://github.com/zachstronaut/stop-sopa">alguna</a> de las <a href="http://www.hellobar.com/pipa/">opciones</a> de <a href="http://wordpress.org/extend/plugins/sopa-blackout-plugin/">apoyo</a> a <a href="http://wordpress.org/extend/plugins/sopa-blackout/">esta</a> campaña. Internet, tal como la conocemos, está en juego. Tu actitud cuenta.</p>
...
?>
	   ...
	   <p> Más info: <a href="http://www.avaaz.org/es/">Avaaz.org</a> | <a href="http://www.blackoutsopa.org/">#BlackoutSOPA</a> | <a href="http://americancensorship.org/">AmericanCensorship.org</a></p>
	   <hr /> 
